...
import com.labtech.backend.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RegistrationValidationExeception.class)
    public ResponseEntity<Map<String,String>> handleRegistrationException( RegistrationValidationExeception ex){
